...
public class ApplianceDAOImpl implements ApplianceDAO {
    ...
    public List<Appliance> find(Criteria criteria) throws DaoException {
        ...
        try {
            ...
            stringAppliances = searchLines(bufferedReader, groupSearchName,
                    criteriaParameters);
            ...
            if (line.contains(groupSearchName)) {
                if (!criteriaParameters.isEmpty()) {
                    ...
                    for (String key : criteriaParameters.keySet()) {
                        ...
                        stringBuilder.append(EQUALLY)
                                .append(criteriaParameters.get(key));
    ...
    private List<Appliance> linesToAppliances(List<String> stringAppliances) {
        ...
        for (String stringAppliance : stringAppliances) {
            Map<String, String> parameters = stringParser
                    .stringToParameters(stringAppliance);
            String applianceName = parameters.get(TYPE);
            ApplianceCreator creator = provider
                    .getApplianceCreator(applianceName);
